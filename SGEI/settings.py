...
SECRET_KEY = 'django-insecure-mt@zu9bt17n6am^@0+d&1d&me2cgdu11mj@#e^arh!r_n+l8vy'
...
SOCIAL_AUTH_PIPELINE = (
    ...
    'social_core.pipeline.usuario.get_username',
    'social_core.pipeline.usuario.create_user',
    'accounts.pipelines.save_profile',
    'social_core.pipeline.social_auth.associate_user',
    'social_core.pipeline.social_auth.load_extra_data',
    'social_core.pipeline.usuario.user_details',
